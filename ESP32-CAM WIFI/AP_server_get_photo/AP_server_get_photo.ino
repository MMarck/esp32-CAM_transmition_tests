...
static camera_config_t camera_config = {
    ...
    .frame_size = FRAMESIZE_UXGA,    //QVGA-UXGA Do not use sizes above QVGA when not JPEG
    .jpeg_quality = 2, //0-63 lower number means higher quality
    .fb_count = 2,       //if more than one, its runs in continuous mode. Use only with JPEG
...
//              esp_camera_fb_return(pic);/
              ...
              // Web Page Heading
              client.println("<body><h1>ESP32 CAM</h1>");
              
              // Display body  
              client.println("<p> A was taken </p>");
              client.println("<p><a href=\"/image.jpg\"><button class=\"button\">See picture</button></a></p>");
              //client.println("<img src=\"/image.jpg\" alt=\"Taken picture\">");
            ...
            if (header.indexOf("GET /image.jpg") >= 0) {
              Serial.println("Picture resquest");
